...
print(parentDir)
ant_file = open(parentDir + r'\antonym-synonym set\Antonym_vietnamese.txt', 'r', encoding='utf8')
ant_lines = ant_file.readlines()

pre_trained_file = open(parentDir + r'\word2vec\W2V_150.txt', 'r', encoding='utf8')
...
sym_file = open(parentDir + r'\antonym-synonym set\Synonym_vietnamese.txt', 'r', encoding='utf8')
...
vicon400_noun_file = open(parentDir + r'\datasets\ViCon-400\400_noun_pairs.txt', 'r', encoding='utf8')
vicon400_noun_lines = vicon400_noun_file.readlines()
read_test_data(vicon400_noun_lines)
vicon400_noun_file.close()

vicon400_verb_file = open(parentDir + r'\datasets\ViCon-400\400_verb_pairs.txt', 'r', encoding='utf8')
vicon400_verb_lines = vicon400_verb_file.readlines()
read_test_data(vicon400_verb_lines)
vicon400_verb_file.close()

vicon400_adj_file = open(parentDir + r'\datasets\ViCon-400\600_adj_pairs.txt', 'r', encoding='utf8')
...
print('Model used: MLPClassifier')
print('Presicion:', metrics.precision_score(y_grounds, y_tests))
print('Recall', metrics.recall_score(y_grounds, y_tests))
print('F1:', metrics.f1_score(y_grounds, y_tests))
